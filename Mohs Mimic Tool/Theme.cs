    ...
    public class MonoFlat_NotificationBox : Control
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (_ShowCloseButton == true)
            {
                ...
                GFX.DrawString("r", new Font("Marlett", 8, FontStyle.Regular), new SolidBrush(Color.FromArgb(32, 41, 50)), new Rectangle(Width - 20, 10, Width, Height), new StringFormat() { Alignment = StringAlignment.Near, LineAlignment = StringAlignment.Near });
            }
